...
public abstract class EconSector implements Serializable{
    ...
    public static EconSector factory(String typeCode){
        switch(typeCode){
            ...
            case "E01": return new AlojamentoRestauracao();
            case "E02": return new Cabeleireiro();
            case "E03": return new Educacao();
            case "E04": return new Familia();
            case "E05": return new Habitacao();
            case "E06": return new Lares();
            case "E07": return new Reparacoes();
            case "E08": return new Saude();
            case "E09": return new Veterinario();
